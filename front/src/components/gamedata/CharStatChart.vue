  ...
  methods: {
    ...
    startFunction() {
      if(this.ranker) {
        ...
        this.SoloData.datasets[0].data = [this.all_stat.solo_avg_win]
        this.SoloPickData.datasets[0].data = [this.all_stat.solo_avg_pick]
        this.SoloKillData.datasets[0].data = [this.all_stat.solo_avg_kill]
        this.SoloRankData.datasets[0].data = [this.all_stat.solo_avg_rank]
        this.DuoData.labels = ['Ranker']
        this.DuoKillData.labels = ['Ranker']
        this.DuoRankData.labels = ['Ranker']
        this.DuoPickData.labels = ['Ranker']
        this.DuoData.datasets[0].data = [this.all_stat.duo_avg_win]
        this.DuoPickData.datasets[0].data = [this.all_stat.duo_avg_pick]
        this.DuoKillData.datasets[0].data = [this.all_stat.duo_avg_kill]
        this.DuoRankData.datasets[0].data = [this.all_stat.duo_avg_rank]
        ...
        this.SquadData.datasets[0].data = [this.all_stat.squad_avg_win]
        this.SquadPickData.datasets[0].data = [this.all_stat.squad_avg_pick]
        this.SquadKillData.datasets[0].data = [this.all_stat.squad_avg_kill]
        this.SquadRankData.datasets[0].data = [this.all_stat.squad_avg_rank]
      } else {
